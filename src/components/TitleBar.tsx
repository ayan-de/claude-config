  ...
  return (
    <div className="flex h-11 w-full items-center justify-between border-b bg-card/30 pl-3 pr-1 select-none tauri-drag">
      <div className="flex items-center gap-3">
        {isMac ? (
          <div className="tauri-no-drag flex items-center gap-1.5">
            <button
              type="button"
              onClick={onClose}
              aria-label="Close"
              className="size-3 rounded-full bg-red-500 transition hover:brightness-110 focus:outline-none focus:ring-1 focus:ring-foreground/20"
            />
            <button
              type="button"
              onClick={onMin}
              aria-label="Minimize"
              className="size-3 rounded-full bg-yellow-500 transition hover:brightness-110 focus:outline-none focus:ring-1 focus:ring-foreground/20"
            />
            <button
              type="button"
              onClick={onToggleMax}
              aria-label={maximized ? "Restore" : "Maximize"}
              className="size-3 rounded-full bg-green-500 transition hover:brightness-110 focus:outline-none focus:ring-1 focus:ring-foreground/20"
            />
          </div>
        ) : null}
        {left}
      ...
      <div className="tauri-no-drag flex items-center gap-0.5">
        {actions}
        <button
          type="button"
          onClick={onMin}
